                ...
                <table class="table table-striped text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $post ['kategori'] ?></td>
                      <td>
                          <a href="/posts/edit/<?= $post['slug'];?>" class="btn btn-warning me-1"> <i class="fas fa-edit"></i> Edit </a>
                          <a href="/posts/delete/<?= $post['slug'];?>" class="btn btn-danger "> <i class="fas fa-trash"></i> Delete </a>
                      </td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
